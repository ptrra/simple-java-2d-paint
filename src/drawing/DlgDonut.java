...
public class DlgDonut extends JDialog
{
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener()
				{
					public void actionPerformed(ActionEvent e)
					{
						try
						{
							d = new Donut(new Point(Integer.parseInt(txtX.getText()), Integer.parseInt(txtY.getText())), 
										Integer.parseInt(txtR.getText()), Integer.parseInt(txtIR.getText()), false, color, innerColor);
							ok = true;
							setVisible(false);
				        }
	...
	public void setTxt(int x, int y, int r, int ir)
	{
